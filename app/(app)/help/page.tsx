...
export default function HelpPage() {
  const videos: Video[] = [
    ...
    },
    {
      ...
      description: "How to create and manage cohorts",
      thumbnail: "https://via.placeholder.com/400x225?text=Managing+Cohorts",
      videoUrl: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
    },
    {
      id: "3",
      title: "Assessment Setup",
      description: "Setting up and configuring assessments",
      thumbnail: "https://via.placeholder.com/400x225?text=Assessment+Setup",
      videoUrl: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
    },
    {
      id: "4",
      ...
      thumbnail: "https://via.placeholder.com/400x225?text=User+Management",
      videoUrl: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
    },
  ];
